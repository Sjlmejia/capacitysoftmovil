...
public class Menu_principal1 extends Activity {
	...
	Handler h2 = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			Toast.makeText(getApplicationContext(), "No hay cupos recursos para esta capacitacion", 4000).show();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Capacitacion_recuperada=(TextView)findViewById(R.id.txt_capRecuperada1);
		 ...
		 cancelar=(Button)findViewById(R.id.btn_cancelarmenuprincipal1);
		...
		registrar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Executors.newSingleThreadExecutor().submit(new Runnable() {
					...
					public void run() {
						// TODO Auto-generated method stub
						data8=vd.httpGetData("http://192.168.1.8/ejemplo/recuperanumcap.php?id="+aux3);
					
							try {
								jas8=new JSONArray(data8);
								String aux=jas8.getString(0);
								Integer a=Integer.parseInt(aux);
								data9=vd.httpGetData("http://192.168.1.8/ejemplo/recuperaidregistro.php?id="+aux3);
								...
								if(jas9.length()>=a){
									...
									vd.httpGetData("http://192.168.1.8/ejemplo/registroasistencia.php?capacitado_id="+aux1+"&capacitacion_id="+aux3);
